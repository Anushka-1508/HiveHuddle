...
function onMessageReceived(payload) {
  ...
  if (message.type === "JOIN") {
    ...
    messageElement.classList.add("event-message");
    message.content = message.sender + " Created Video Call!";
  }
  else {
...
const newMeetingBtn = document.getElementById("video-chat");
newMeetingBtn.addEventListener("click", videoCall);

function handelJoinMeetingEvent(){
...
const joinVideoChat = document.getElementById("joinVideoChat");
joinVideoChat.addEventListener("click", handelJoinMeetingEvent);
